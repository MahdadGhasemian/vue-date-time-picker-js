...
export default {
  ...
  props: {
     ...
     * @type String
     * @default Null
     * @example YYYY/MM/DD HH:mm | YYYY/MM/DD HH:mm | x | unix | HH:mm
     ...
     * @type String
     * @default Null
     * @example 1988/03/09 22:45 | 22:45
     */
     ...
     * @example ['1988/03/09', '1988/10/10'] - "1988/03/09" - /1988\/05\/(.*)/ ...
     */
  ...
  computed: {
    ...
    formattedDate() {
      ...
      if (this.hasStep('d')) format = 'ddd DD MMMM'
      if (this.hasStep('t')) format += ' HH:mm '

      return format ? this.selectedDate.format(format) : ''
    },
    month() {
    ...
    years() {
      ...
      let min = this.minDate ? this.minDate : moment('2000', 'YYYY')
