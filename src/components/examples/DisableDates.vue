<template>
  <div>
    ...
    <card title="Disable Dates">
      <div v-if="tab === 'd'" key="d" class="mt-5">
        <date-picker
          initial-value="1988/05/01"
          placeholder="String"
          disable="1988/05/09"
        />
        <br />
        ...
        <date-picker
          ...
          :disable="['1988/05/07', '1988/05/08', 'Friday']"
        />
        <br />
        <date-picker
          initial-value="1988/05/01"
      ...
      <div v-if="tab === 'dt'" key="dt" class="mt-5">
        <date-picker
          initial-value="1997/05/06 22:00"
          type="datetime"
          placeholder="String"
          disable="1997/05/06 22:00"
        />
        <br />
        <date-picker
          initial-value="1997/05/06 22:05"
          type="datetime"
          placeholder="Array of strings"
          :disable="['1997/05/04', '1997/05/06 22:05', 'Friday']"
        />
        <br />
        <date-picker
          initial-value="1997/05/05 12:00"
          type="datetime"
          placeholder="Regular Expressions"
          :disable="/1997\/05\/0[1-9] 12:(.*)/"
        />
        <br />
        <date-picker
          initial-value="1997/05/01 22:15"
          type="datetime"
          placeholder="Array of strings and RegExp"
          :disable="['1997/05/06 12:00', /(.*)22:(.*)/]"
        />
      </div>
      ...
      <template slot="code">
        ...
        <template v-if="tab === 'd'">
          ...
          <highlight-code lang="html" v-pre>
            String
            &lt;date-picker disable="1997/05/09" /&gt;

            Day name
            &lt;date-picker disable="Friday" /&gt;

            Array of strings
            &lt;date-picker :disable="['1997/05/07', '1997/05/08', 'Friday']" /&gt;

            Regular Expressions
            &lt;date-picker :disable="/1997\/05\/1(.*)/" /&gt;

            Array of strings and RegExp
            &lt;date-picker :disable="['1997/05/06', /1997\/05\/1(.*)/]" /&gt;
            ...
            &lt;script&gt;
              ...
              methods: {
                checkDate(formatted, dateMoment, checkingFor) {
                  return (
                    formatted === '1997/04/03' ||
                    dateMoment.month() === 4  ||  // means "mordad"
        ...
        <template v-if="tab === 'y'">
          ...
          <highlight-code lang="html" v-pre>
            String
            &lt;date-picker type="year" disable="1996" /&gt;

            Array of strings
            &lt;date-picker type="year" :disable="['1998', '1999']" /&gt;

            Regular Expressions
            &lt;date-picker type="year" :disable="/199[2-6]/" /&gt;

            Array of strings and RegExp
            &lt;date-picker type="year" :disable="['1998', /198[1-9]/]" /&gt;
          </highlight-code>
          <!-- eslint-enable -->
        </template>
        ...
        <template v-if="tab === 'dt'">
          ...
          <highlight-code lang="html" v-pre>
            String
            &lt;date-picker type="datetime" disable="1997/05/06 22:00" /&gt;

            Array of strings
            &lt;date-picker type="datetime" :disable="['1997/05/05', '1997/05/06 22:05', 'Friday']" /&gt;

            Regular Expressions
            &lt;date-picker type="datetime" :disable="/1997\/05\/0[1-9] 12:(.*)/" /&gt;

            Array of strings and RegExp
            &lt;date-picker type="datetime" :disable="['1997/05/06 12:00', /(.*)22:(.*)/]" /&gt;
          </highlight-code>
          <!-- eslint-enable -->
        </template>
      </template>
